...
# train_set = pd.read_csv("../../data/train_filtered_with_oneshot.csv", quoting=3, on_bad_lines='skip')
# val_set = pd.read_csv("../../data/val_filtered_with_oneshot.csv", quoting=3, on_bad_lines='skip')
...
val_set['source']=val_set['source'].apply(prefix_one_shot_example)
